...
function buildPrompt(mcqJson) {
  return `
NEETPG Exam is based on Pattern that repeats . Based on above what is expected Repeatedly asked Pattern of High Yiedl facts as Tables of UWORLD , FIRST AID STYLE NEED TO BE REMEBEBERED pATTERN IN THE SENSE , IF THEY ASKED A SIDE EFFECT OF emla , side effect of all anaesthetics worth remembering for NEETPG SHOULD BE A table . yOU NEED TO COVER THE WHOLE CONTENT Clinical Expand Pattern Tables to remeber on the EXPECTED FUTURE QUESTIONS (PATTERN EXPANSION) Give as Mark Up code of only Tables Use Unicode for Superscripts , Subscripts, Symbols , Math , Greek Letters Give as Code
